...
import com.yassine.donationplatform.security.auth.dto.AdminLoginRequest;
import com.yassine.donationplatform.security.auth.dto.AuthTokenResponse;
import com.yassine.donationplatform.security.admin.AdminProps;
import com.yassine.donationplatform.security.jwt.JwtService;
...
public class AdminAuthService {
    ...
    public static final long ACCESS_TTL_SECONDS = 15 * 60; // 15 min (recommandé)
    ...
    public AuthResult login(AdminLoginRequest req, HttpServletRequest httpReq) {
        ...
        // ✅ admin unique : seul l’email configuré peut se connecter
