...
import com.yassine.donationplatform.service.DonationAdminService;
...
public class DonationAdminController {
    ...
    public ResponseEntity<byte[]> exportCsv(
        ...
        // Export complet (sans pagination) — OK pour MVP si volume faible.
        // Si gros volume, on fera un export async plus tard.
